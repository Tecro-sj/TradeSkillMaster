...
L["Send"] = true
L["Contacts"] = true
L["Open contacts menu to select recipients."] = true
L["Subject:"] = true
L["Subject line for the mail. This will be auto-filled based on items or gold sent."] = true
L["Message:"] = true
L["Optional message body for the mail."] = true
L["Items:"] = true
L["Gold / Silver / Copper:"] = true
L["Enter the amount of money to send. Format: XXXg YYs ZZc"] = true
L["Send Money"] = true
L["Send money directly to the recipient."] = true
L["C.O.D."] = true
L["Send items with Cash on Delivery - recipient pays on receiving."] = true
L["Send Mail"] = true
L["Click to send the mail. If more than 12 items, multiple mails will be sent."] = true
L["Please enter a recipient name."] = true
L["Please add items or gold to send."] = true
L["Sending mail to %s..."] = true
L["Mail sent successfully!"] = true
L["Sending %d mails to %s..."] = true
L["You have no friends online."] = true
