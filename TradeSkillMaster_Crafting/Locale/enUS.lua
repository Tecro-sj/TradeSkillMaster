...
L["Opens or closes the standalone Task List window showing your crafting queue and materials."] = true
L["Refresh"] = true
L["Task List"] = true
...
L["Please open the profession window first."] = true
L["Opening profession window..."] = true
L["Clearing filters and reopening profession window..."] = true
