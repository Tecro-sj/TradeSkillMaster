...
L["A Quick Scan will scan individual items from your last Full Scan, but only the first 5 pages per item. This is much faster than a Full Scan and provides a good overview of market prices for all items. You must run a Full Scan first to build the item list."] = true
...
L["Quick Scan (max %d pages): page %s/%s"] = true
L["Quick Scan (%d/%d): %s - %s [%d/%d]"] = true
L["Quick Scan (%d/%d): %s [%d/%d]"] = true
L["Run Quick Scan"] = true
L["Please run a Full Scan first to build the item list for Quick Scan."] = true
L["Starting Quick Scan with %d items (list is %d days old)"] = true
L["Saved %d items for Quick Scan"] = true
...
L["DB Min Buyout (Avg 50):"] = true
L["DB Min Buyout (Avg 50) x%s:"] = true
L["Min Buy (Avg 50):"] = true
L["Min Buy (Avg 50) x%s:"] = true
L["Display DBMinBuyout (7-day avg of 50 cheapest) in tooltip."] = true
L["If checked, the DBMinBuyout value (7-day weighted average of the 50 cheapest auctions) will be displayed."] = true
L["Display MinBuy (avg of 50 cheapest) in tooltip."] = true
L["If checked, the MinBuy value (average of the 50 cheapest auctions) will be displayed."] = true
L["Show price change indicators"] = true
L["If checked, price changes will be displayed with color-coded arrows showing if prices have increased or decreased."] = true
L["Price change time period"] = true
L["Select how many days back to compare prices for the change indicator."] = true
L["1 day"] = true
L["3 days"] = true
L["7 days"] = true
L["14 days"] = true
...
L["Market Value"] = true
L["Market Value:"] = true
L["Min Buyout (Cheapest) x%s:"] = true
L["Min Buyout (Cheapest):"] = true
