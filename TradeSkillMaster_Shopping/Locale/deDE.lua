...
L["Max Pages for /exact Searches (0 = unlimited)"] = "Max. Seiten für /exact Suchen (0 = unbegrenzt)"
-- L["Maximum Auction Price (per item)"] = ""
L["Maximum number of pages to scan for /exact searches. Set to 0 for unlimited pages, or 1-10 to limit scanning to the first few pages for faster results."] = "Maximale Anzahl der zu scannenden Seiten für /exact Suchen. Setze auf 0 für unbegrenzte Seiten, oder 1-10 um das Scannen auf die ersten Seiten zu begrenzen für schnellere Ergebnisse."
