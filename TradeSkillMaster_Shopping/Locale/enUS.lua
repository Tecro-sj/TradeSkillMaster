...
L["Max Pages for /exact Searches (0 = unlimited)"] = true
L["Max Shopping Price:"] = true
L["Maximum Auction Price (per item)"] = true
L["Maximum number of pages to scan for /exact searches. Set to 0 for unlimited pages, or 1-10 to limit scanning to the first few pages for faster results."] = true
