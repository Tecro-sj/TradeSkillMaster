...
function Util:StartFilterScan(filters, callback)
	...
	private.maxPagesForExact = nil
	if #filters == 1 and filters[1].exactOnly and TSM.db.global.exactSearchMaxPages > 0 then
		private.maxPagesForExact = TSM.db.global.exactSearchMaxPages
	end
...
function private:ScanNextFilter()
	...
	TSMAPI.AuctionScan:RunQuery(private.filterList[1], private.ScanCallback, true, private.callback("filter", private.filterList[1]), true, private.maxPagesForExact)
end
