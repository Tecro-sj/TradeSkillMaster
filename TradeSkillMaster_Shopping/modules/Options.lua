			...
			children = {
				{
					...
					children = {
						{
							type = "Slider",
							label = L["Max Pages for /exact Searches (0 = unlimited)"],
							settingInfo = { TSM.db.global, "exactSearchMaxPages" },
							min = 0,
							max = 10,
							step = 1,
							isPercent = false,
							relativeWidth = 1,
							tooltip = L["Maximum number of pages to scan for /exact searches. Set to 0 for unlimited pages, or 1-10 to limit scanning to the first few pages for faster results."],
						},
						{
							type = "EditBox",
